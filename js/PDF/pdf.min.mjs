  ...
  n = {
    640: (t, e, i) => {
      ...
      class AnnotationElement {
        ...
        _createContainer(t) {
          ...
          const { width: c, height: u } = getRectDims(e.rect),
        ...
        _createQuadrilaterals() {
          ...
          for (const [, { x: i, y: s }, { x: a, y: d }] of t) {
            ...
            u.append(t);
            r?.push(
              `<rect vector-effect="non-scaling-stroke" x="${c}" y="${p}" width="${g}" height="${m}"/>`
            );
          }
          if (this.#t) {
            r.push("</g></svg>')");
        ...
        _getElementsByName(t, e = null) {
          ...
          if (this._fieldObjects) {
            ...
            if (n)
              for (const { page: t, id: a, exportValues: r } of n) {
                ...
                !o || l.has(o)
                  ? i.push({ id: a, exportValue: n, domElement: o })
                  : (0, s.warn)(
          ...
          for (const s of document.getElementsByName(t)) {
            ...
            n !== e &&
              l.has(s) &&
              i.push({ id: n, exportValue: t, domElement: s });
          }
          return i;
        }
        show() {
            ...
            t.onclick = () => {
              ...
              if (0 !== t.length || 0 !== n.length) {
                ...
                for (const t of Object.values(this._fieldObjects))
                  for (const i of t) e.has(i.id) === a && r.push(i);
              } else
              ...
              this.enableScripting &&
                this.linkService.eventBus?.dispatch("dispatcheventinsandbox", {
                  source: this,
                  detail: { id: "app", ids: h, name: "ResetForm" },
                });
              return !1;
            };
          else {
      ...
      class WidgetAnnotationElement extends AnnotationElement {
        ...
        _setBackgroundColor(t) {
          ...
          t.style.backgroundColor =
            null === e ? "transparent" : s.Util.makeHexColor(e[0], e[1], e[2]);
        }
        _setTextStyle(t) {
      ...
      class TextWidgetAnnotationElement extends WidgetAnnotationElement {
        ...
        render() {
          ...
          if (this.renderForms) {
            ...
            let r =
              s.formattedValue || this.data.textContent?.join("\n") || null;
            ...
            s.addEventListener("updatefromsandbox", (i) => {
              const n = {
                ...
                remove(i) {
                  ...
                  if (n.length > 0) {
                    -1 ===
                      Array.prototype.findIndex.call(n, (t) => t.selected) &&
                      (n[0].selected = !0);
                  }
      ...
      class PopupAnnotationElement extends AnnotationElement {
        ...
        render() {
          ...
          this.container.setAttribute(
            "aria-controls",
            e.map((t) => `${s.AnnotationPrefix}${t}`).join(",")
          );
          return this.container;
        }
      }
      class PopupElement {
        ...
        render() {
          ...
          const {
            ...
            o = (this.#y = document.createElement("div"));
          o.className = "popup";
          if (this.#u) {
            ...
            if (
              ...
              const t = 0.7;
              o.style.backgroundColor = s.Util.makeHexColor(
                ...this.#u.map((e) => Math.floor(t * (255 - e) + e))
              );
            }
          }
          ...
          if (!c?.str || (d?.str && d.str !== c.str)) {
            ...
            r.XfaLayer.render({ xfaHtml: c.html, intent: "richText", div: o });
        ...
        #a(t) {
          t.altKey ||
            ...
            t.ctrlKey ||
            t.metaKey ||
            (("Enter" === t.key || ("Escape" === t.key && this.#v)) &&
              this.#c());
        }
        #c() {
          this.#v = !this.#v;
      ...
      class LineAnnotationElement extends AnnotationElement {
        ...
        render() {
          ...
          const t = this.data,
            ...
            n = (this.#S = this.svgFactory.createElement("svg:line"));
      ...
      class SquareAnnotationElement extends AnnotationElement {
        ...
        render() {
          ...
          const t = this.data,
            ...
            a = (this.#C = this.svgFactory.createElement("svg:rect"));
      ...
      class CircleAnnotationElement extends AnnotationElement {
        ...
        render() {
          ...
          const t = this.data,
            ...
            s = this.svgFactory.create(e, i, !0),
            n = t.borderStyle.width,
            a = (this.#T = this.svgFactory.createElement("svg:ellipse"));
      ...
      class PolylineAnnotationElement extends AnnotationElement {
        ...
        render() {
          ...
          n = n.join(" ");
          const a = (this.#M = this.svgFactory.createElement(
            this.svgElementName
          ));
    ...
    780: (t, e, i) => {
      ...
      var s = i(266),
        n = i(796),
        a = i(825);
      const r = Object.freeze({ map: null, hash: "", transfer: void 0 });
      class AnnotationStorage {
        ...
        get serializable() {
          ...
          return t.size > 0 ? { map: t, hash: e.hexdigest(), transfer: i } : r;
        }
      }
      class PrintAnnotationStorage extends AnnotationStorage {
        ...
        constructor(t) {
          ...
          this.#z = { map: n, hash: i, transfer: s };
        }
        get print() {
        ...
        try {
          ...
          const y = 65536,
            ...
            C = n.isNodeJS
              ...
              : r.DOMStandardFontDataFactory;
          function getDocument(t) {
            "string" == typeof t || t instanceof URL
              ? (t = { url: t })
              : (0, n.isArrayBuffer)(t) && (t = { data: t });
            if ("object" != typeof t)
              throw new Error(
            ...
            const v = t.verbosity,
              E =
                ...
                (0, r.isDataScheme)(t.docBaseUrl)
                  ? null
                  : t.docBaseUrl,
              _ = "string" == typeof t.cMapUrl ? t.cMapUrl : null,
              T = !1 !== t.cMapPacked,
              ...
              I =
                "boolean" == typeof t.isOffscreenCanvasSupported
                  ...
                  : !n.isNodeJS,
              L = Number.isInteger(t.canvasMaxAreaInBytes)
              ...
              G =
                "boolean" == typeof t.useWorkerFetch
                  ? t.useWorkerFetch
                  : M === r.DOMCMapReaderFactory &&
                    P === r.DOMStandardFontDataFactory &&
                    _ &&
                    F &&
                    (0, r.isValidFetchUrl)(_, document.baseURI) &&
                    (0, r.isValidFetchUrl)(F, document.baseURI),
              $ = t.canvasFactory || new x({ ownerDocument: U }),
              X = t.filterFactory || new S({ docId: i, ownerDocument: U });
            (0, n.setVerbosityLevel)(v);
            const K = { canvasFactory: $, filterFactory: X };
            if (!G) {
              K.cMapReaderFactory = new M({ baseUrl: _, isCompressed: T });
              K.standardFontDataFactory = new P({ baseUrl: F });
            }
            if (!A) {
              const t = {
                verbosity: v,
                ...
                const t = _fetchDocument(A, Y),
                  h = new Promise(function (t) {
                    ...
                    if (u)
                      ...
                      e = ((t) =>
                        n.isNodeJS
                          ? new b.PDFNodeStream(t)
                          : (0, r.isValidFetchUrl)(t.url)
                          ? new m.PDFFetchStream(t)
                          : new f.PDFNetworkStream(t))({
                        url: s,
                        length: W,
                        httpHeaders: o,
                        withCredentials: l,
          ...
          class PDFPageProxy {
            ...
            getTextContent(t = {}) {
              if (this._transport._htmlForXfa)
                return this.getXfa().then((t) => A.XfaText.textContent(t));
            ...
            _abortOperatorList({ intentState: t, reason: e, force: i = !1 }) {
              if (t.streamReader) {
                ...
                t.streamReader
                  .cancel(new n.AbortException(e.message))
                  .catch(() => {});
                t.streamReader = null;
                if (!this._transport.destroyed) {
          ...
          class PDFWorker {
            ...
            constructor({
              ...
              if (e) {
                if (PDFWorker.#X?.has(e))
                  throw new Error(
                    "Cannot use more than one PDFWorker per port."
                  );
                (PDFWorker.#X ||= new WeakMap()).set(e, this);
            ...
            _initialize() {
              if (!T.isWorkerDisabled && !PDFWorker.#K) {
                let { workerSrc: t } = PDFWorker;
                try {
                  T.isSameOrigin(window.location.href, t) ||
                    (t = T.createCDNWrapper(new URL(t, window.location).href));
          ...
          class WorkerTransport {
            ...
            getRenderingIntent(
              ...
              switch (e) {
                ...
                case n.AnnotationMode.ENABLE_STORAGE:
                  ...
                  o = (
                    r & n.RenderingIntentFlag.PRINT &&
                    i instanceof a.PrintAnnotationStorage
                      ? i
            ...
            destroy() {
              ...
              Promise.all(t).then(() => {
                ...
                this._networkStream?.cancelAllRequests(
                  new n.AbortException("Worker was terminated.")
                );
            ...
            setupMessageHandler() {
              ...
              t.on("DocException", function (t) {
                ...
                switch (t.name) {
                  ...
                  default:
                    (0,
                    n.unreachable)("DocException - expected a valid Error.");
                }
              ...
              t.on("PasswordRequest", (t) => {
                ...
                if (e.onPassword) {
                  ...
                  this.#Z.reject(new n.PasswordException(t.message, t.code));
                ...
                if (!this.destroyed && !this.commonObjs.has(e))
                  switch (i) {
                    case "Font":
                      ...
                      const r =
                          a.pdfBug && globalThis.FontInspector?.enabled
                    ...
                    switch (i) {
                      case "Image":
                        ...
                        if (s) {
                          ...
                          t > n.MAX_IMAGE_SIZE_TO_CACHE &&
                            (a._maybeCleanupAfterRender = !0);
                        }
                        break;
                      case "Pattern":
                        a.objs.resolve(t, s);
            ...
            getOptionalContentConfig() {
              return this.messageHandler
                ...
                .then((t) => new p.OptionalContentConfig(t));
            }
            getPermissions() {
              return this.messageHandler.sendWithPromise(
                "GetPermissions",
          ...
          class InternalRenderTask {
            ...
            initializeGraphics({
              ...
              if (this._canvas) {
                if (InternalRenderTask.#nt.has(this._canvas))
                  throw new Error(
      ...
      class BaseFilterFactory {
        constructor() {
          this.constructor === BaseFilterFactory &&
            (0, s.unreachable)("Cannot initialize BaseFilterFactory.");
        }
        addFilter(t) {
          return "none";
        }
    ...
    250: (t, e, i) => {
      ...
      class MeshShadingPattern extends BaseShadingPattern {
        ...
        getPattern(t, e, i, a) {
          ...
          let r;
          if (a === o)
            r = s.Util.singularValueDecompose2dScale(
              (0, n.getCurrentTransform)(t)
            );
          else {
      ...
      class TilingPattern {
        ...
        createPatternCanvas(t) {
          ...
          E.translate(-A.scale * x, -v.scale * w);
          _.transform(A.scale, 0, 0, v.scale, 0, 0);
          E.save();
          this.clipBbox(_, x, w, S, C);
      ...
      function drawImageAtIntegerCoords(t, e, i, s, a, r, o, l, h, d) {
        ...
        if (0 === u && 0 === p) {
          const n = o * c + m,
            ...
            v = Math.round(A),
            y = (o + h) * c + m,
            E = Math.abs(Math.round(y) - b) || 1,
            _ = (l + d) * g + f,
            x = Math.abs(Math.round(_) - v) || 1;
          t.setTransform(Math.sign(c), 0, 0, Math.sign(g), b, v);
          t.drawImage(e, i, s, a, r, 0, 0, E, x);
      ...
      class CanvasExtraState {
        ...
        getPathBoundingBox(t = a, e = null) {
          ...
          if (t === r) {
            e ||
              (0, s.unreachable)("Stroke bounding box must include transform.");
        ...
        if (0 !== r && 0 !== o) {
          !(function genericComposeSMask(t, e, i, s, n, a, r, o, l, h, d) {
            const c = !!a,
              ...
              g = c ? a[2] : 0,
              m =
                "Luminosity" === n ? composeSMaskLuminosity : composeSMaskAlpha,
      ...
      class CanvasGraphics {
        ...
        _createMaskCanvas(t) {
          ...
          const [m, f, b, A] = s.Util.getAxialAlignedBoundingBox(
            ...
            v = Math.round(b - m) || 1,
            y = Math.round(A - f) || 1,
            E = this.cachedCanvases.getCanvas("fillCanvas", v, y),
            _ = E.context,
            x = m,
            w = f;
          _.translate(-x, -w);
          ...
          _.fillStyle = l ? o.getPattern(e, this, S, a) : o;
          _.fillRect(0, 0, i, r);
          if (d && !l) {
        ...
        paintChar(t, e, i, a) {
          ...
          if (l.disableFontFace || p) {
            ...
            g(r, d);
            a && r.setTransform(...a);
            (c !== s.TextRenderingMode.FILL &&
              c !== s.TextRenderingMode.FILL_STROKE) ||
              r.fill();
            (c !== s.TextRenderingMode.STROKE &&
              c !== s.TextRenderingMode.FILL_STROKE) ||
              r.stroke();
            r.restore();
          } else {
        ...
        showText(t) {
          ...
          if (0 === E || 0 === y) {
            const t =
              e.textRenderingMode & s.TextRenderingMode.FILL_STROKE_MASK;
        ...
        showType3Text(t) {
          ...
          let p, g, m, f;
          if (
            !(i.textRenderingMode === s.TextRenderingMode.INVISIBLE) &&
            0 !== a
          ) {
            this._cachedScaleForStroking[0] = -1;
            this._cachedGetSinglePixelWidth = null;
        ...
        paintImageMaskXObjectGroup(t) {
          ...
          for (const r of t) {
            ...
            c.fillStyle = s
              ? i.getPattern(c, this, (0, n.getCurrentTransformInverse)(e), a)
              : i;
            c.fillRect(0, 0, o, l);
            c.restore();
            e.save();
    ...
    473: (t, e, i) => {
      ...
      class DOMFilterFactory extends s.BaseFilterFactory {
        ...
        get #At() {
          if (!this.#lt) {
            const t = this.#ht.createElement("div"),
              { style: e } = t;
            e.visibility = "hidden";
            e.contain = "strict";
            e.width = e.height = 0;
        ...
        addFilter(t) {
          ...
          const r = `g_${this.#H}_transfer_map_${this.#ft++}`,
            o = `url(#${r})`;
          this.#bt.set(t, o);
          this.#bt.set(n, o);
          const l = this.#vt(r);
        ...
        addHighlightHCMFilter(t, e, i, s) {
          ...
          const getSteps = (t, e, i) => {
            ...
            c = `g_${this.#H}_hcm_highlight_filter`,
            u = (this.#pt = this.#vt(c));
          this.#_t(u);
          this.#yt(
            getSteps(h[0], d[0], 5),
      ...
      class DOMCMapReaderFactory extends s.BaseCMapReaderFactory {
        _fetchData(t, e) {
          return fetchData(t, this.isCompressed ? "arraybuffer" : "text").then(
            (t) => ({
              cMapData:
                t instanceof ArrayBuffer
                  ? new Uint8Array(t)
    ...
    423: (t, e, i) => {
      ...
      class DrawLayer {
        ...
        static #St(t, { x: e, y: i, width: s, height: n }) {
          const { style: a } = t;
          a.top = 100 * i + "%";
          a.left = 100 * e + "%";
          a.width = 100 * s + "%";
        ...
        updateBox(t, e) {
          DrawLayer.#St(this.#wt.get(t), e);
        }
        rotate(t, e) {
          this.#wt.get(t).setAttribute("data-main-rotation", e);
        }
        changeColor(t, e) {
          this.#wt.get(t).setAttribute("fill", e);
        }
        changeOpacity(t, e) {
          this.#wt.get(t).setAttribute("fill-opacity", e);
        }
        addClass(t, e) {
          this.#wt.get(t).classList.add(e);
        }
        removeClass(t, e) {
          this.#wt.get(t).classList.remove(e);
        }
        remove(t) {
          this.#wt.get(t).remove();
          this.#wt.delete(t);
        }
        destroy() {
          this.#b = null;
          for (const t of this.#wt.values()) t.remove();
          this.#wt.clear();
        }
      }
    },
    331: (t, e, i) => {
      ...
      class FreeTextEditor extends n.AnnotationEditor {
        ...
        #Ft = this.editorDivFocus.bind(this);
        #Pt = this.editorDivInput.bind(this);
        #Rt = this.editorDivKeydown.bind(this);
        #u;
        #kt = "";
        #Dt = `${this.id}-editor`;
        #It;
        ...
        get propertiesToUpdate() {
          return [
            [s.AnnotationEditorParamsType.FREETEXT_SIZE, this.#It],
            [s.AnnotationEditorParamsType.FREETEXT_COLOR, this.#u],
          ];
        }
        #Ot(t) {
          const setFontsize = (t) => {
        ...
        enableEditMode() {
          if (!this.isInEditMode()) {
            ...
            this.editorDiv.addEventListener("focus", this.#Ft);
            this.editorDiv.addEventListener("blur", this.#Mt);
            this.editorDiv.addEventListener("input", this.#Pt);
          }
        }
        disableEditMode() {
          if (this.isInEditMode()) {
            ...
            this.editorDiv.removeEventListener("focus", this.#Ft);
            this.editorDiv.removeEventListener("blur", this.#Mt);
            this.editorDiv.removeEventListener("input", this.#Pt);
        ...
        serialize(t = !1) {
          ...
          const e = FreeTextEditor._internalPadding * this.parentScale,
            i = this.getRect(e, e),
            a = n.AnnotationEditor._colorManager.convert(
        ...
        #jt(t) {
          ...
          return (
            t.value !== e ||
            t.fontSize !== i ||
            t.rect.some((t, e) => Math.abs(t - n[e]) >= 1) ||
      ...
      class InkEditor extends n.AnnotationEditor {
        #Vt = 0;
        #Wt = 0;
        #qt = this.canvasPointermove.bind(this);
        #Gt = this.canvasPointerleave.bind(this);
        #$t = this.canvasPointerup.bind(this);
        #Xt = this.canvasPointerdown.bind(this);
        #Kt = null;
        #Yt = new Path2D();
        #Jt = !1;
        #Qt = !1;
        ...
        enableEditMode() {
          if (!this.#Jt && null !== this.canvas) {
            super.enableEditMode();
            this._isDraggable = !1;
            this.canvas.addEventListener("pointerdown", this.#Xt);
          }
        }
        disableEditMode() {
          if (this.isInEditMode() && null !== this.canvas) {
            ...
            this.canvas.removeEventListener("pointerdown", this.#Xt);
          }
        }
        onceAdded() {
          this._isDraggable = !this.isEmpty();
        ...
        #pe(t, e) {
          ...
          this.canvas.addEventListener("pointerleave", this.#Gt);
          this.canvas.addEventListener("pointermove", this.#qt);
        ...
        #me(t, e) {
          ...
          if (n.length <= 2) {
            ...
            if (3 === n.length) {
              this.#Yt = a = new Path2D();
              a.moveTo(...n[0]);
            }
            this.#fe(a, ...n.at(-3), ...n.at(-2), t, e);
          }
        }
        #be() {
        ...
        #Ae(t, e) {
          ...
          this.#be();
          let i;
          if (1 !== this.currentPath.length) i = this.#ve();
          else {
            const s = [t, e];
        ...
        canvasPointerdown(t) {
          if (0 === t.button && this.isInEditMode() && !this.#Jt) {
            this.setInForeground();
            t.preventDefault();
            "mouse" === t.pointerType ||
        ...
        #Ee(t) {
          this.canvas.removeEventListener("pointerleave", this.#Gt);
          this.canvas.removeEventListener("pointermove", this.#qt);
        ...
        #he() {
          this.#te = new ResizeObserver((t) => {
            const e = t[0].contentRect;
            e.width && e.height && this.setDimensions(e.width, e.height);
          });
          this.#te.observe(this.div);
        }
        get isResizable() {
          return !this.isEmpty() && this.#Jt;
        }
        render() {
          if (this.div) return this.div;
          let t, e;
        ...
        #Te(t, e, i, s) {
          ...
          for (const e of this.paths) {
            ...
            n.push({
              bezier: InkEditor.#Se(i, s, this.rotation),
              points: InkEditor.#Se(a, s, this.rotation),
            });
          }
          return n;
        }
        ...
        #xe() {
          return this.#Jt ? Math.ceil(this.thickness * this.parentScale) : 0;
        }
        #re(t = !1) {
          ...
          const e = this.#Me(),
            i = this.#xe();
          this.#Wt = Math.max(n.AnnotationEditor.MIN_SIZE, e[2] - e[0]);
          this.#Vt = Math.max(n.AnnotationEditor.MIN_SIZE, e[3] - e[1]);
          const s = Math.ceil(i + this.#Wt * this.scaleFactor),
            a = Math.ceil(i + this.#Vt * this.scaleFactor),
        ...
        static deserialize(t, e, i) {
          ...
          const f = a.#Me();
          a.#Wt = Math.max(n.AnnotationEditor.MIN_SIZE, f[2] - f[0]);
          a.#Vt = Math.max(n.AnnotationEditor.MIN_SIZE, f[3] - f[1]);
          a.#_e(h, d);
          return a;
        }
        serialize() {
      ...
      class StampEditor extends n.AnnotationEditor {
        ...
        #He() {
          ...
          if (this.#ke) {
            ...
            this.#ke = null;
            this._uiManager.enableWaiting(!0);
            this.#Re = this._uiManager.imageManager
              .getFromUrl(t)
              .then((t) => this.#Ue(t))
              .finally(() => this.#ze());
            return;
        ...
        remove() {
          if (this.#Pe) {
            this.#Fe = null;
            this._uiManager.imageManager.deleteId(this.#Pe);
            this.#Le?.remove();
            this.#Le = null;
            this.#te?.disconnect();
            this.#te = null;
        ...
        isEmpty() {
          return !(this.#Re || this.#Fe || this.#ke || this.#De);
        }
        get isResizable() {
          return !0;
        }
        ...
        #le() {
          ...
          this._uiManager.enableWaiting(!1);
          const l = (this.#Le = document.createElement("canvas"));
          t.append(l);
          t.hidden = !1;
          this.#je(e, i);
          this.#he();
          ...
          this.#Ie && l.setAttribute("aria-label", this.#Ie);
        }
        #Ve(t, e) {
          const [i, s] = this.parentDimensions;
          this.width = t / i;
          ...
          this._initialOptions?.isCentered
            ...
            : this.fixAndSetPosition();
          this._initialOptions = null;
          null !== this.#Oe && clearTimeout(this.#Oe);
          this.#Oe = setTimeout(() => {
            this.#Oe = null;
            this.#je(t, e);
          }, 200);
        ...
        #We(t, e) {
          const { width: i, height: s } = this.#Fe;
          let n = i,
            a = s,
            r = this.#Fe;
          for (; n > 2 * t || a > 2 * e; ) {
        ...
        #je(t, e) {
          ...
          i.width = t;
          i.height = e;
          const s = this.#Be ? this.#Fe : this.#We(t, e),
            n = i.getContext("2d");
        ...
        #qe(t) {
          if (t) {
            if (this.#Be) {
              const t = this._uiManager.imageManager.getSvgUrl(this.#Pe);
              if (t) return t;
            }
            const t = document.createElement("canvas");
            ({ width: t.width, height: t.height } = this.#Fe);
            t.getContext("2d").drawImage(this.#Fe, 0, 0);
            return t.toDataURL();
          }
          if (this.#Be) {
            const [t, e] = this.pageDimensions,
              ...
              s = Math.round(
                this.height * e * o.PixelsPerInch.PDF_TO_CSS_UNITS
              ),
          ...
          return structuredClone(this.#Fe);
        }
        #he() {
          this.#te = new ResizeObserver((t) => {
            const e = t[0].contentRect;
            e.width && e.height && this.#Ve(e.width, e.height);
          });
          this.#te.observe(this.div);
        }
        static deserialize(t, e, i) {
          ...
          o && i.imageManager.isValidId(o) ? (s.#Pe = o) : (s.#ke = a);
          s.#Be = l;
        ...
        serialize(t = !1, e = null) {
          ...
          const r = this.#Be
            ...
            : null;
          if (e.stamps.has(this.#Pe)) {
            if (this.#Be) {
              const t = e.stamps.get(this.#Pe);
              if (r > t.area) {
                t.area = r;
                t.serialized.bitmap.close();
                t.serialized.bitmap = this.#qe(!1);
              }
            }
          } else {
            e.stamps.set(this.#Pe, { area: r, serialized: i });
            i.bitmap = this.#qe(!1);
          }
          return i;
        }
      ...
      class AnnotationEditorLayer {
        ...
        #Ge = !1;
        #$e = null;
        #Xe = this.pointerup.bind(this);
        #Ke = this.pointerdown.bind(this);
        #Ye = null;
        #Je = new Map();
        #Qe = !1;
        #Ze = !1;
        ...
        static #ii = new Map(
          [FreeTextEditor, InkEditor, StampEditor].map((t) => [
            t._editorType,
            t,
          ])
        );
        constructor({
          ...
          const o = [...AnnotationEditorLayer.#ii.values()];
          if (!AnnotationEditorLayer._initialized) {
            AnnotationEditorLayer._initialized = !0;
            for (const t of o) t.initialize(r);
          }
          t.registerEditorTypes(o);
          this.#ei = t;
          this.pageIndex = e;
          this.div = i;
          this.#k = s;
          this.#$e = n;
          this.viewport = a;
          this.#ei.addLayer(this);
        }
        get isEmpty() {
          return 0 === this.#Je.size;
        }
        updateToolbar(t) {
          this.#ei.updateToolbar(t);
        }
        updateMode(t = this.#ei.getMode()) {
          this.#si();
          ...
          if (t !== s.AnnotationEditorType.NONE) {
            ...
            for (const i of AnnotationEditorLayer.#ii.values())
              e.toggle(`${i._type}Editing`, t === i._editorType);
            this.div.hidden = !1;
          }
        }
        addInkEditorIfNeeded(t) {
          if (!t && this.#ei.getMode() !== s.AnnotationEditorType.INK) return;
          if (!t)
          ...
          this.#ni({ offsetX: 0, offsetY: 0 }, !1).setInBackground();
        }
        setEditingState(t) {
          this.#ei.setEditingState(t);
        }
        addCommands(t) {
          this.#ei.addCommands(t);
        }
        ...
        enable() {
          ...
          const t = new Set();
          for (const e of this.#Je.values()) {
            e.enableEditing();
            e.annotationElementId && t.add(e.annotationElementId);
          }
          if (!this.#$e) return;
          const e = this.#$e.getEditableAnnotations();
          for (const i of e) {
            i.hide();
            if (this.#ei.isDeletedAnnotationElement(i.data.id)) continue;
        ...
        disable() {
          ...
          if (this.#$e) {
            ...
            for (const i of e) {
              const { id: e } = i.data;
              t.has(e) || this.#ei.isDeletedAnnotationElement(e) || i.show();
            }
          }
          this.#si();
          this.isEmpty && (this.div.hidden = !0);
          const { classList: e } = this.div;
          for (const t of AnnotationEditorLayer.#ii.values())
            e.remove(`${t._type}Editing`);
          this.#ti = !1;
        }
        getEditableAnnotation(t) {
          return this.#$e?.getEditableAnnotation(t) || null;
        }
        setActiveEditor(t) {
          this.#ei.getActive() !== t && this.#ei.setActiveEditor(t);
        }
        enableClick() {
          this.div.addEventListener("pointerdown", this.#Ke);
          this.div.addEventListener("pointerup", this.#Xe);
        }
        disableClick() {
          this.div.removeEventListener("pointerdown", this.#Ke);
          this.div.removeEventListener("pointerup", this.#Xe);
        }
        attach(t) {
          this.#Je.set(t.id, t);
          const { annotationElementId: e } = t;
          e &&
            this.#ei.isDeletedAnnotationElement(e) &&
            this.#ei.removeDeletedAnnotationElement(t);
        }
        detach(t) {
          this.#Je.delete(t.id);
          ...
          !this.#ti &&
            ...
            this.#ei.addDeletedAnnotationElement(t);
        }
        remove(t) {
          this.detach(t);
          this.#ei.removeEditor(t);
          t.div.remove();
          t.isAttachedToDOM = !1;
          this.#Ze || this.addInkEditorIfNeeded(!1);
        }
        changeParent(t) {
          if (t.parent !== this) {
            if (t.annotationElementId) {
              this.#ei.addDeletedAnnotationElement(t.annotationElementId);
        ...
        add(t) {
          ...
          t.fixAndSetPosition();
          t.onceAdded();
          this.#ei.addToAnnotationStorage(t);
        }
        moveEditorInDOM(t) {
          if (!t.isAttachedToDOM) return;
          const { activeElement: e } = document;
          if (t.div.contains(e) && !this.#Ye) {
          ...
          t._structTreeParentId = this.#k?.moveElementInDOM(
            this.div,
            t.div,
            t.contentDiv,
            !0
        ...
        getNextId() {
          return this.#ei.getId();
        }
        #ai(t) {
          const e = AnnotationEditorLayer.#ii.get(this.#ei.getMode());
          return e ? new e.prototype.constructor(t) : null;
        }
        pasteEditor(t, e) {
          this.#ei.updateToolbar(t);
          this.#ei.updateMode(t);
          const { offsetX: i, offsetY: s } = this.#ri(),
            n = this.getNextId(),
            a = this.#ai({
              parent: this,
              id: n,
        ...
        deserialize(t) {
          return (
            AnnotationEditorLayer.#ii
              .get(t.annotationType ?? t.annotationEditorType)
              ?.deserialize(t, this, this.#ei) || null
          );
        }
        #ni(t, e) {
        ...
        setSelected(t) {
          this.#ei.setSelected(t);
        }
        toggleSelected(t) {
          this.#ei.toggleSelected(t);
        }
        isSelected(t) {
          return this.#ei.isSelected(t);
        }
        unselect(t) {
          this.#ei.unselect(t);
        }
        pointerup(t) {
          ...
          if (
            ...
            this.#Qe = !1;
            this.#Ge
              ? this.#ei.getMode() !== s.AnnotationEditorType.STAMP
                ? this.#ni(t, !1)
                : this.#ei.unselectAll()
              : (this.#Ge = !0);
          }
        ...
        pointerdown(t) {
          ...
          this.#Qe = !0;
          const i = this.#ei.getActive();
          this.#Ge = !i || i.isEmpty();
        }
        findNewParent(t, e, i) {
          const s = this.#ei.findParent(e, i);
          if (null === s || s === this) return !1;
          s.changeParent(t);
          return !0;
        }
        destroy() {
          if (this.#ei.getActive()?.parent === this) {
            this.#ei.commitOrRemove();
            this.#ei.setActiveEditor(null);
          }
          if (this.#Ye) {
          ...
          this.div = null;
          this.#Je.clear();
          this.#ei.removeLayer(this);
        }
        #si() {
          this.#Ze = !0;
          for (const t of this.#Je.values()) t.isEmpty() && t.remove();
          this.#Ze = !1;
        }
        render({ viewport: t }) {
          this.viewport = t;
          (0, o.setLayerDimensions)(this.div, t);
          for (const t of this.#ei.getEditors(this.pageIndex)) this.add(t);
          this.updateMode();
        }
        update({ viewport: t }) {
          this.#ei.commitOrRemove();
    ...
    796: (t, e, i) => {
      ...
      class EditorToolbar {
        ...
        render() {
          const t = (this.#oi = document.createElement("div"));
          t.className = "editToolbar";
          t.addEventListener("contextmenu", a.noContextMenu);
          t.addEventListener("pointerdown", EditorToolbar.#di);
          const e = (this.#hi = document.createElement("div"));
          e.className = "buttons";
          t.append(e);
          this.#ci();
          return t;
        ...
        #ui(t) {
          this.#li._focusEventsAllowed = !1;
          t.preventDefault();
          t.stopPropagation();
        }
        #pi(t) {
          this.#li._focusEventsAllowed = !0;
          t.preventDefault();
          t.stopPropagation();
        }
        #gi(t) {
          t.addEventListener("focusin", this.#ui.bind(this), { capture: !0 });
          t.addEventListener("focusout", this.#pi.bind(this), { capture: !0 });
          t.addEventListener("contextmenu", a.noContextMenu);
        }
        hide() {
          this.#oi.classList.add("hidden");
        }
        show() {
          this.#oi.classList.remove("hidden");
        }
        #ci() {
          const t = document.createElement("button");
          t.className = "delete";
          t.tabIndex = 0;
          t.setAttribute("data-l10n-id", "pdfjs-editor-remove-button");
          this.#gi(t);
          t.addEventListener("click", (t) => {
            this.#li._uiManager.delete();
          });
          this.#hi.append(t);
        }
        remove() {
      ...
      class AnnotationEditor {
        ...
        #xi = null;
        #wi = null;
        #Si = this.focusin.bind(this);
        #Ci = this.focusout.bind(this);
        #Ti = null;
        #Mi = "";
        #Fi = !1;
        #Pi = !1;
        ...
        focusin(t) {
          this._focusEventsAllowed &&
            (this.#Fi ? (this.#Fi = !1) : this.parent.setSelected(this));
        }
        focusout(t) {
        ...
        translate(t, e) {
          this.#Bi(this.parentDimensions, t, e);
        }
        translateInPage(t, e) {
          this.#Bi(this.pageDimensions, t, e);
        ...
        screenToPageTranslation(t, e) {
          return AnnotationEditor.#Ui(t, e, this.parentRotation);
        }
        pageTranslationToScreen(t, e) {
          return AnnotationEditor.#Ui(t, e, 360 - this.parentRotation);
        }
        #zi(t) {
          switch (t) {
            case 90: {
        ...
        setDims(t, e) {
          ...
          this.#_i ||
            (this.div.style.height = `${((100 * e) / s).toFixed(2)}%`);
        ...
        #Hi() {
          ...
          this.#xi.classList.add("resizers");
          ...
          for (const e of t) {
            ...
            t.addEventListener("pointerdown", this.#ji.bind(this, e));
            t.addEventListener("contextmenu", a.noContextMenu);
            t.tabIndex = -1;
          }
          this.div.prepend(this.#xi);
        }
        #ji(t, e) {
          e.preventDefault();
        ...
        #Wi(t, e) {
          const [i, s] = this.parentDimensions,
            ...
            d = this.#zi(this.rotation),
            transf = (t, e) => [d[0] * t + d[2] * e, d[1] * t + d[3] * e],
            c = this.#zi(360 - this.rotation);
          let u,
            p,
            g = !1,
            m = !1;
          ...
          [x, w] =
            ((S = x / i),
            (C = w / s),
            [c[0] * S + c[2] * C, c[1] * S + c[3] * C]);
          var S, C;
          if (g) {
            const t = Math.hypot(r, o);
            E = _ = Math.max(
              Math.min(
                Math.hypot(b[0] - f[0] - x, b[1] - f[1] - w) / t,
                1 / r,
                1 / o
              ),
              l / r,
            ...
            m
              ? (E = Math.max(l, Math.min(1, Math.abs(b[0] - f[0] - x))) / r)
              : (_ = Math.max(h, Math.min(1, Math.abs(b[1] - f[1] - w))) / o);
          const T = round(r * E),
            M = round(o * _);
          A = transf(...p(T, M));
          const F = v - A[0],
        ...
        async addAltTextButton() {
          if (this.#Ai) return;
          const t = (this.#Ai = document.createElement("button"));
          t.className = "altText";
          ...
          if (!AnnotationEditor.SMALL_EDITOR_SIZE) {
            ...
            AnnotationEditor.SMALL_EDITOR_SIZE = Math.min(
              128,
              Math.round(t.getBoundingClientRect().width * (1 + e / 100))
            );
          }
        }
        async #Gi() {
          ...
          let e = this.#vi;
          if (!e) {
            this.#vi = e = document.createElement("span");
            e.className = "tooltip";
        ...
        altTextFinish() {
          if (this.#Ai) {
            this.#Ai.hidden = !1;
            this.#Ai.focus({ focusVisible: this.#Ei });
            this.#Ei = !1;
          }
        }
        addEditToolbar() {
          if (!this.#Ti && !this.#Ri) {
            this.#Ti = new EditorToolbar(this);
            this.div.append(this.#Ti.render());
          }
        }
        removeEditToolbar() {
          if (this.#Ti) {
        ...
        get altTextData() {
          return { altText: this.#fi, decorative: this.#bi };
        }
        set altTextData({ altText: t, decorative: e }) {
          if (this.#fi !== t || this.#bi !== e) {
            this.#fi = t;
            this.#bi = e;
            this.#Gi();
          }
        ...
        render() {
          ...
          this.setInForeground();
          this.div.addEventListener("focusin", this.#Si);
          this.div.addEventListener("focusout", this.#Ci);
          const [t, e] = this.parentDimensions;
        ...
        remove() {
          this.div.removeEventListener("focusin", this.#Si);
          this.div.removeEventListener("focusout", this.#Ci);
          this.isEmpty() || this.commit();
          this.parent
        ...
        keydown(t) {
          ...
          const e = this.#xi.children;
          if (!this.#mi) {
            this.#mi = Array.from(e);
            const t = this.#Xi.bind(this),
              i = this.#Ki.bind(this);
            for (const e of this.#mi) {
              ...
              e.addEventListener("focus", this.#Yi.bind(this, s));
              AnnotationEditor._l10nPromise
                .get(`pdfjs-editor-resizer-label-${s}`)
                .then((t) => e.setAttribute("aria-label", t));
            }
          }
          const i = this.#mi[0];
          let s = 0;
          ...
          if (n !== s) {
            if (n < s)
              for (let t = 0; t < s - n; t++)
                this.#xi.append(this.#xi.firstChild);
            else if (n > s)
              for (let t = 0; t < n - s; t++)
                this.#xi.firstChild.before(this.#xi.lastChild);
            let t = 0;
            for (const i of e) {
              const e = this.#mi[t++].getAttribute("data-resizer-name");
              AnnotationEditor._l10nPromise
                .get(`pdfjs-editor-resizer-label-${e}`)
                .then((t) => i.setAttribute("aria-label", t));
            }
          }
          this.#Ji(0);
          this.#ki = !0;
          this.#xi.firstChild.focus({ focusVisible: !0 });
          t.preventDefault();
        ...
        #Ki(t) {
          this.#ki && t.relatedTarget?.parentNode !== this.#xi && this.#Oi();
        }
        #Yi(t) {
          this.#Mi = this.#ki ? t : "";
        }
        #Ji(t) {
          if (this.#mi) for (const e of this.#mi) e.tabIndex = t;
        }
        _resizeWithKeyboard(t, e) {
          this.#ki && this.#Wi(this.#Mi, { movementX: t, movementY: e });
        }
        #Oi() {
          this.#ki = !1;
          this.#Ji(-1);
        ...
        updateParams(t, e) {}
        disableEditing() {
          this.#Ai && (this.#Ai.hidden = !0);
        }
        enableEditing() {
          this.#Ai && (this.#Ai.hidden = !1);
        }
        enterInEditMode() {}
        getImageForAltText() {
          return null;
      ...
      class Outliner {
        ...
        constructor(t, e = 0, i = 0, s = !0) {
          ...
          const h = a - n + 2 * i,
            ...
            p = this.#Zi.at(s ? -1 : -2),
            g = [p[0], p[2]];
          for (const t of this.#Zi) {
            const [e, i, s] = t;
            t[0] = (e - c) / h;
            t[1] = (i - u) / d;
            t[2] = (s - u) / d;
          }
          this.#Qi = { x: c, y: u, width: h, height: d, lastPoint: g };
        }
        getOutlines() {
          this.#Zi.sort((t, e) => t[0] - e[0] || t[1] - e[1] || t[2] - e[2]);
          const t = [];
        ...
        #is([, t, e]) {
          const i = this.#as(t);
          this.#ts.splice(i, 0, [t, e]);
        }
        #ss([, t, e]) {
          const i = this.#as(t);
          for (let s = i; s < this.#ts.length; s++) {
            const [i, n] = this.#ts[s];
            if (i !== t) break;
            if (i === t && n === e) {
              this.#ts.splice(s, 1);
    ...
    812: (t, e, i) => {
      ...
      class ImageManager {
        ...
        isValidId(t) {
          return t.startsWith(`image_${this.#rs}_`);
        }
      }
      class CommandManager {
        ...
        add({
          ...
          if (-1 === this.#cs) {
            this.#ls.length > 0 && (this.#ls.length = 0);
            this.#cs = 0;
            this.#ls.push(r);
            return;
          }
          if (n && this.#ls[this.#cs].type === s) {
            a && (r.undo = this.#ls[this.#cs].undo);
            this.#ls[this.#cs] = r;
            return;
          }
          const o = this.#cs + 1;
          if (o === this.#ds) this.#ls.splice(0, 1);
          else {
            this.#cs = o;
            o < this.#ls.length && this.#ls.splice(o);
          }
          this.#ls.push(r);
        }
        undo() {
          if (-1 !== this.#cs) {
            this.#hs = !0;
            this.#ls[this.#cs].undo();
            this.#hs = !1;
            this.#cs -= 1;
          }
        }
        redo() {
          if (this.#cs < this.#ls.length - 1) {
            this.#cs += 1;
            this.#hs = !0;
            this.#ls[this.#cs].cmd();
            this.#hs = !1;
        ...
        hasSomethingToRedo() {
          return this.#cs < this.#ls.length - 1;
        }
        destroy() {
          this.#ls = null;
        }
      ...
      class KeyboardManager {
        ...
        exec(t, e) {
          ...
          const i = this.callbacks.get(this.#us(e));
          if (!i) return;
          const {
            callback: s,
      ...
      class AnnotationEditorUIManager {
        ...
        #Ts = !1;
        #Ms = null;
        #Fs = s.AnnotationEditorType.NONE;
        #Ps = new Set();
        #Rs = null;
        #ks = this.blur.bind(this);
        #Ds = this.focus.bind(this);
        #Is = this.copy.bind(this);
        #Ls = this.cut.bind(this);
        #Os = this.paste.bind(this);
        #Bs = this.keydown.bind(this);
        #Ns = this.onEditingAction.bind(this);
        #Us = this.onPageChanging.bind(this);
        #zs = this.onScaleChanging.bind(this);
        #Hs = this.onRotationChanging.bind(this);
        #js = {
          isEditing: !1,
          isEmpty: !0,
        ...
        static get _keyboardManager() {
          const t = AnnotationEditorUIManager.prototype,
            arrowChecker = (t) =>
              t.#p.contains(document.activeElement) &&
        ...
        constructor(t, e, i, s, a, r) {
          ...
          this.#fs = i;
          this._eventBus = s;
          this._eventBus._on("editingaction", this.#Ns);
          this._eventBus._on("pagechanging", this.#Us);
          this._eventBus._on("scalechanging", this.#zs);
          this._eventBus._on("rotationchanging", this.#Hs);
          this.#bs = a.annotationStorage;
          this.#xs = a.filterFactory;
          this.#Rs = r;
          this.viewParameters = {
        ...
        destroy() {
          this.#Gs();
          this.#$s();
          this._eventBus._off("editingaction", this.#Ns);
          this._eventBus._off("pagechanging", this.#Us);
          this._eventBus._off("scalechanging", this.#zs);
          this._eventBus._off("rotationchanging", this.#Hs);
          for (const t of this.#ms.values()) t.destroy();
          this.#ms.clear();
          this.#gs.clear();
          this.#_s.clear();
          this.#ps = null;
        ...
        get hcmFilter() {
          return (0, s.shadow)(
            ...
            "hcmFilter",
            this.#Rs
              ? this.#xs.addHCMFilter(this.#Rs.foreground, this.#Rs.background)
              : "none"
          );
        }
        get direction() {
          return (0, s.shadow)(
            this,
            "direction",
            getComputedStyle(this.#p).direction
          );
        }
        editAltText(t) {
          this.#fs?.editAltText(this, t);
        }
        ...
        disableUserSelect(t = !1) {
          this.#qs.classList.toggle("noUserSelect", t);
        }
        addShouldRescale(t) {
          this.#_s.add(t);
        }
        ...
        addToAnnotationStorage(t) {
          t.isEmpty() ||
            !this.#bs ||
            this.#bs.has(t.id) ||
            this.#bs.setValue(t.id, t);
        }
        #Xs() {
          window.addEventListener("focus", this.#Ds);
          window.addEventListener("blur", this.#ks);
        }
        #$s() {
          window.removeEventListener("focus", this.#Ds);
          window.removeEventListener("blur", this.#ks);
        }
        blur() {
        ...
        #Ks() {
          window.addEventListener("keydown", this.#Bs);
        }
        #Gs() {
          window.removeEventListener("keydown", this.#Bs);
        }
        #Ys() {
          document.addEventListener("copy", this.#Is);
          document.addEventListener("cut", this.#Ls);
          document.addEventListener("paste", this.#Os);
        }
        #Js() {
          document.removeEventListener("copy", this.#Is);
          document.removeEventListener("cut", this.#Ls);
          document.removeEventListener("paste", this.#Os);
        }
        addEditListeners() {
          this.#Ks();
          this.#Ys();
        ...
        #tn(t) {
          Object.entries(t).some(([t, e]) => this.#js[t] !== e) &&
            this._eventBus.dispatch("annotationeditorstateschanged", {
              source: this,
              details: Object.assign(this.#js, t),
            });
        }
        #en(t) {
        ...
        setEditingState(t) {
          if (t) {
            ...
            this.#Ys();
            this.#tn({
              isEditing: this.#Fs !== s.AnnotationEditorType.NONE,
              isEmpty: this.#in(),
              hasSomethingToUndo: this.#As.hasSomethingToUndo(),
              hasSomethingToRedo: this.#As.hasSomethingToRedo(),
              hasSelectedEditor: !1,
            });
          } else {
            this.#$s();
        ...
        registerEditorTypes(t) {
          if (!this.#ii) {
            this.#ii = t;
            for (const t of this.#ii) this.#en(t.defaultPropertiesToUpdate);
          }
        }
        getId() {
        ...
        get currentLayer() {
          return this.#ms.get(this.#vs);
        }
        getLayer(t) {
          return this.#ms.get(t);
        }
        get currentPageIndex() {
          return this.#vs;
        }
        addLayer(t) {
          this.#ms.set(t.pageIndex, t);
          this.#Cs ? t.enable() : t.disable();
        }
        removeLayer(t) {
          this.#ms.delete(t.pageIndex);
        }
        updateMode(t, e = null, i = !1) {
          if (this.#Fs !== t) {
            ...
            if (t !== s.AnnotationEditorType.NONE) {
              ...
              this.#sn();
              this.unselectAll();
              for (const e of this.#ms.values()) e.updateMode(t);
              if (e || !i) {
                if (e)
                  for (const t of this.#gs.values())
        ...
        updateParams(t, e) {
          if (this.#ii)
            if (t !== s.AnnotationEditorParamsType.CREATE) {
              for (const i of this.#Ps) i.updateParams(t, e);
              for (const i of this.#ii) i.updateDefaultParams(t, e);
            } else this.currentLayer.addNewEditor();
        }
        enableWaiting(t = !1) {
          if (this.#Ts !== t) {
            this.#Ts = t;
            for (const e of this.#ms.values()) {
        ...
        #sn() {
          if (!this.#Cs) {
            this.#Cs = !0;
            for (const t of this.#ms.values()) t.enable();
          }
        }
        #nn() {
          this.unselectAll();
          if (this.#Cs) {
            this.#Cs = !1;
            for (const t of this.#ms.values()) t.disable();
          }
        }
        getEditors(t) {
          const e = [];
          for (const i of this.#gs.values()) i.pageIndex === t && e.push(i);
          return e;
        }
        getEditor(t) {
        ...
        removeEditor(t) {
          ...
          this.#gs.delete(t.id);
          this.unselect(t);
          (t.annotationElementId && this.#ys.has(t.annotationElementId)) ||
            this.#bs?.remove(t.id);
        }
        ...
        #Qs(t) {
          const e = this.#ms.get(t.pageIndex);
          e ? e.addOrRebuild(t) : this.addEditor(t);
        }
        setActiveEditor(t) {
          if (this.#ps !== t) {
            this.#ps = t;
            t && this.#en(t.propertiesToUpdate);
          }
        }
        toggleSelected(t) {
          if (this.#Ps.has(t)) {
            this.#Ps.delete(t);
            t.unselect();
            this.#tn({ hasSelectedEditor: this.hasSelection });
          } else {
            this.#Ps.add(t);
            t.select();
            this.#en(t.propertiesToUpdate);
            this.#tn({ hasSelectedEditor: !0 });
          }
        }
        setSelected(t) {
          for (const e of this.#Ps) e !== t && e.unselect();
          this.#Ps.clear();
          this.#Ps.add(t);
          t.select();
          this.#en(t.propertiesToUpdate);
        ...
        isSelected(t) {
          return this.#Ps.has(t);
        }
        get firstSelectedEditor() {
          return this.#Ps.values().next().value;
        }
        unselect(t) {
          t.unselect();
          this.#Ps.delete(t);
        ...
        get hasSelection() {
          return 0 !== this.#Ps.size;
        }
        get isEnterHandled() {
          return 1 === this.#Ps.size && this.firstSelectedEditor.isEnterHandled;
        }
        undo() {
          this.#As.undo();
          this.#tn({
        ...
        #in() {
          if (0 === this.#gs.size) return !0;
          if (1 === this.#gs.size)
            for (const t of this.#gs.values()) return t.isEmpty();
          return !1;
        }
        delete() {
          this.commitOrRemove();
        ...
        hasSomethingToControl() {
          return this.#ps || this.hasSelection;
        }
        #Zs(t) {
          this.#Ps.clear();
          for (const e of t)
        ...
        selectAll() {
          for (const t of this.#Ps) t.commit();
          this.#Zs(this.#gs.values());
        }
        unselectAll() {
          if (this.#ps) this.#ps.commitOrRemove();
          else if (this.hasSelection) {
            for (const t of this.#Ps) t.unselect();
            this.#Ps.clear();
            this.#tn({ hasSelectedEditor: !1 });
          }
        }
        translateSelectedEditors(t, e, i = !1) {
          ...
          this.#Ws = setTimeout(() => {
            this.#Ws = null;
            this.#Vs[0] = this.#Vs[1] = 0;
            this.addCommands({
              cmd: () => {
                for (const t of a)
                  this.#gs.has(t.id) && t.translateInPage(s, n);
              },
              undo: () => {
                for (const t of a)
                  this.#gs.has(t.id) && t.translateInPage(-s, -n);
        ...
        dragSelectedEditors(t, e) {
          if (this.#Es) for (const i of this.#Es.keys()) i.drag(t, e);
        }
        rebuild(t) {
          if (null === t.parent) {
          ...
          fetch(
            ...
            .then((t) => {
              if (!(0, n.validateResponseStatus)(t.status))
                throw (0, n.createResponseStatusError)(t.status, i);
    ...
    742: (t, e, i) => {
      ...
      class FontLoader {
        ...
        async loadSystemFont({ systemFontInfo: t, _inspectFont: e }) {
          if (t && !this.#an.has(t.loadedName)) {
            (0, s.assert)(
              !this.disableFontFace,
              "loadSystemFont shouldn't be called when `disableFontFace` is set."
            );
            if (this.isFontLoadingAPISupported) {
              const { loadedName: i, src: n, style: a } = t,
    ...
    472: (t, e, i) => {
      ...
      class Metadata {
        ...
        get(t) {
          return this.#rn.get(t) ?? null;
        }
        getAll() {
          return (0, s.objectFromMap)(this.#rn);
        }
        has(t) {
          return this.#rn.has(t);
        }
      }
    },
    474: (t, e, i) => {
      ...
      class PDFNetworkStreamFullRequestReader {
        ...
        _onHeadersReceived() {
          const t = this._fullRequestId,
            ...
            { allowRangeRequests: i, suggestedLength: s } = (0,
            n.validateRangeRequestCapabilities)({
              getResponseHeader: getResponseHeader,
    ...
    253: (t, e, i) => {
      ...
      function createResponseStatusError(t, e) {
        return 404 === t || (0 === t && e.startsWith("file:"))
          ? new s.MissingPDFException('Missing PDF "' + e + '".')
            ...
            class PDFNodeStreamFsRangeReader extends BaseRangeReader {
              constructor(t, e, i) {
                ...
                this._setReadableStream(
                  r.createReadStream(s, { start: e, end: i - 1 })
                );
              }
            }
            s();
    ...
    890: (t, e, i) => {
      ...
      class OptionalContentGroup {
        ...
        _setVisible(t, e) {
          t !== a &&
            (0, s.unreachable)("Internal method `_setVisible` called.");
          this.#ln = e;
        }
      }
      class OptionalContentConfig {
        ...
        constructor(t) {
          ...
          if (null !== t) {
            ...
            for (const e of t.groups)
              this.#dn.set(e.id, new OptionalContentGroup(e.name, e.intent));
            if ("OFF" === t.baseState)
              for (const t of this.#dn.values()) t._setVisible(a, !1);
            for (const e of t.on) this.#dn.get(e)._setVisible(a, !0);
            for (const e of t.off) this.#dn.get(e)._setVisible(a, !1);
            this.#cn = this.getHash();
          }
        }
        #pn(t) {
          const e = t.length;
          ...
          for (let n = 1; n < e; n++) {
            const e = t[n];
            let a;
            if (Array.isArray(e)) a = this.#pn(e);
            else {
              if (!this.#dn.has(e)) {
                (0, s.warn)(`Optional content group not found: ${e}`);
                return !0;
              }
              a = this.#dn.get(e).visible;
            }
            switch (i) {
              case "And":
                if (!a) return !1;
        ...
        isVisible(t) {
          ...
          if ("OCG" === t.type) {
            ...
            return this.#dn.get(t.id).visible;
          }
          if ("OCMD" === t.type) {
            if (t.expression) return this.#pn(t.expression);
            if (!t.policy || "AnyOn" === t.policy) {
              for (const e of t.ids) {
                ...
                if (this.#dn.get(e).visible) return !0;
              }
              return !1;
            }
            if ("AllOn" === t.policy) {
              for (const e of t.ids) {
                ...
                if (!this.#dn.get(e).visible) return !1;
              }
              return !0;
            }
            if ("AnyOff" === t.policy) {
        ...
        setVisibility(t, e = !0) {
          if (this.#dn.has(t)) {
            this.#dn.get(t)._setVisible(a, !!e);
            this.#hn = null;
          } else (0, s.warn)(`Optional content group not found: ${t}`);
        }
        get hasInitialVisibility() {
          return null === this.#cn || this.getHash() === this.#cn;
        }
        getOrder() {
          return this.#dn.size
            ? this.#un
        ...
        getGroups() {
          return this.#dn.size > 0 ? (0, s.objectFromMap)(this.#dn) : null;
        }
        getGroup(t) {
          return this.#dn.get(t) || null;
        }
        getHash() {
          if (null !== this.#hn) return this.#hn;
          const t = new n.MurmurHash3_64();
          for (const [e, i] of this.#dn) t.update(`${e}:${i.visible}`);
    ...
    739: (t, e, i) => {
      ...
      function getCtx(t, e) {
        ...
        if (e && s.FeatureTest.isOffscreenCanvasSupported)
          i = new OffscreenCanvas(t, t).getContext("2d", { alpha: !1 });
        else {
      ...
      function appendText(t, e, i) {
        ...
        const u =
            (t._fontInspectorEnabled && c.fontSubstitution) || c.fontFamily,
        ...
        t._fontInspectorEnabled &&
          (n.dataset.fontName = c.fontSubstitutionLoadedName || e.fontName);
      ...
      class XfaLayer {
        ...
        static render(t) {
          ...
          for (; d.length > 0; ) {
            ...
            const u = l?.attributes?.xmlns
              ? document.createElementNS(l.attributes.xmlns, c)
            ...
            if (l.children?.length > 0) d.push([l, -1, u]);
            else if (l.value) {
              const t = document.createTextNode(l.value);
      ...
      i.a(t, async (t, s) => {
        try {
          i.d(e, {
            ...
            DrawLayer: () => c.DrawLayer,
            FeatureTest: () => n.FeatureTest,
            GlobalWorkerOptions: () => u.GlobalWorkerOptions,
      ...
      class MessageHandler {
        constructor(t, e, i) {
          ...
          this._onComObjOnMessage = (t) => {
            ...
            } else e.streamId ? this.#mn(e) : s(e.data);
          };
    ...
    266: (t, e, i) => {
      ...
      const s = !(
        ...
        b = { SOLID: 1, DASHED: 2, BEVELED: 3, INSET: 4, UNDERLINE: 5 },
        A = { ERRORS: 0, WARNINGS: 1, INFOS: 5 },
        v = { NONE: 0, BINARY: 1 },
        y = {
          dependency: 1,
          setLineWidth: 2,
      ...
      function normalizeUnicode(t) {
        ...
        return t.replaceAll(S, (t, e, i) =>
          e ? e.normalize("NFKC") : C.get(i)
        );
      }
      function getUuid() {
        if (
...
var r = __webpack_require__(907),
  o = (r = globalThis.pdfjsLib = await (globalThis.pdfjsLibPromise = r))
    .AbortException,
  ...
  f = r.DrawLayer,
  b = r.FeatureTest,
  A = r.GlobalWorkerOptions,
  v = r.ImageKind,
  y = r.InvalidPDFException,
  E = r.MissingPDFException,
  _ = r.OPS,
  x = r.Outliner,
  w = r.PDFDataRangeTransport,
  S = r.PDFDateString,
  C = r.PDFWorker,
  T = r.PasswordResponses,
  M = r.PermissionFlag,
  F = r.PixelsPerInch,
  P = r.PromiseCapability,
  R = r.RenderingCancelledException,
  k = r.UnexpectedResponseException,
  D = r.Util,
  I = r.VerbosityLevel,
  L = r.XfaLayer,
  O = r.build,
  B = r.createValidAbsoluteUrl,
  N = r.fetchData,
  U = r.getDocument,
  z = r.getFilenameFromUrl,
  H = r.getPdfFilenameFromUrl,
  j = r.getXfaPageViewport,
  V = r.isDataScheme,
  W = r.isPdfFile,
  q = r.noContextMenu,
  G = r.normalizeUnicode,
  $ = r.renderTextLayer,
  X = r.setLayerDimensions,
  K = r.shadow,
  Y = r.updateTextLayer,
  J = r.version;
export {
  ...
  c as AnnotationEditorUIManager,
  ...
  f as DrawLayer,
  b as FeatureTest,
  A as GlobalWorkerOptions,
  v as ImageKind,
  y as InvalidPDFException,
  E as MissingPDFException,
  _ as OPS,
  x as Outliner,
  w as PDFDataRangeTransport,
  S as PDFDateString,
  C as PDFWorker,
  T as PasswordResponses,
  M as PermissionFlag,
  F as PixelsPerInch,
  P as PromiseCapability,
  ...
  j as getXfaPageViewport,
  V as isDataScheme,
  W as isPdfFile,
  q as noContextMenu,
  G as normalizeUnicode,
  $ as renderTextLayer,
  X as setLayerDimensions,
  K as shadow,
  Y as updateTextLayer,
  J as version,
};
